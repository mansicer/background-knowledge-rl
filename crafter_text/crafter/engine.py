...
class TextView(SemanticView):
    ...
    def local_sentence_view(self, player):
        ...
        if obj is not None:
            sentence_obs = sentence_obs + " You are targeting " + obj.name.lower() + "."
        elif material is not None and material not in ["path", "sand", "lava"]:
            sentence_obs = sentence_obs + " You are targeting " + material + "."
        return sentence_obs
